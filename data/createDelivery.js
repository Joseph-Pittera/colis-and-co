...
const type_of_marchandise = faker.commerce.productName();
...
const delivery = {type_of_marchandise, quantity, volume, length, width, height, departure_address, arrival_address, departure_date, arrival_date, price};
